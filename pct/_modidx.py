...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'pct.architectures': { 'pct.architectures.BaseArchitecture': ('architectures.html#basearchitecture', 'pct/architectures.py'),
            ...
            'pct.microgrid': { 'pct.microgrid.MicroGridEnvPlus': ('microgrid.html#microgridenvplus', 'pct/microgrid.py'),
                               'pct.microgrid.MicroGridEnvPlus.__init__': ('microgrid.html#microgridenvplus.__init__', 'pct/microgrid.py'),
                               'pct.microgrid.MicroGridEnvPlus._build_state': ( 'microgrid.html#microgridenvplus._build_state',
                                                                                'pct/microgrid.py'),
