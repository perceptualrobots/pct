  ...
  'syms': { 'pct.architectures': { 'pct.architectures.BaseArchitecture': ('architectures.html#basearchitecture', 'pct/architectures.py'),
            ...
            'pct.environments': { 'pct.environments.CartPoleDV1': ('environments.html#cartpoledv1', 'pct/environments.py'),
                                  ...
                                  'pct.environments.ControlEnvironment.get_parameters_list': ( 'environments.html#controlenvironment.get_parameters_list',
                                                                                               'pct/environments.py'),
                                  'pct.environments.ControlEnvironment.process_action': ( 'environments.html#controlenvironment.process_action',
                                                                                          'pct/environments.py'),
                                  ...
                                  'pct.environments.WebotsWrestler.get_obs': ( 'environments.html#webotswrestler.get_obs',
                                                                               'pct/environments.py'),
                                  'pct.environments.WebotsWrestler.get_sensor_values': ( 'environments.html#webotswrestler.get_sensor_values',
                                                                                         'pct/environments.py'),
