...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'pct.applications': {'pct.applications.run_wind_turbine': ('applications.html#run_wind_turbine', 'pct/applications.py')},
            ...
            'pct.environments': { 'pct.environments.ARC': ('environments.html#arc', 'pct/environments.py'),
                                  ...
                                  'pct.environments.GenericGym.add_specific_metrics': ( 'environments.html#genericgym.add_specific_metrics',
                                                                                        'pct/environments.py'),
                                  ...
                                  'pct.environments.GymMetaData.get_env_inputs_indexes': ( 'environments.html#gymmetadata.get_env_inputs_indexes',
                                                                                           'pct/environments.py'),
                                  'pct.environments.GymMetaData.get_env_inputs_names': ( 'environments.html#gymmetadata.get_env_inputs_names',
                                                                                         'pct/environments.py'),
