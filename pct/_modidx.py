  ...
  'syms': { 'pct.architectures': { 'pct.architectures.BaseArchitecture': ('architectures.html#basearchitecture', 'pct/architectures.py'),
            ...
            'pct.environments': { 'pct.environments.CartPoleDV1': ('environments.html#cartpoledv1', 'pct/environments.py'),
                                  ...
                                  'pct.environments.OpenAIGym.get_graph_name': ( 'environments.html#openaigym.get_graph_name',
                                                                                 'pct/environments.py'),
                                  'pct.environments.OpenAIGym.get_obs': ('environments.html#openaigym.get_obs', 'pct/environments.py'),
                                  ...
                                  'pct.environments.WebotsWrestler.__init__': ( 'environments.html#webotswrestler.__init__',
                                                                                'pct/environments.py'),
                                  'pct.environments.WebotsWrestler.connect': ( 'environments.html#webotswrestler.connect',
                                                                               'pct/environments.py'),
                                  ...
                                  'pct.environments.WebotsWrestler.get_graph_name': ( 'environments.html#webotswrestler.get_graph_name',
                                                                                      'pct/environments.py'),
                                  'pct.environments.WebotsWrestler.get_obs': ( 'environments.html#webotswrestler.get_obs',
                                                                               'pct/environments.py'),
                                  'pct.environments.WebotsWrestler.init_inputs': ( 'environments.html#webotswrestler.init_inputs',
                                                                                   'pct/environments.py'),
                                  'pct.environments.WebotsWrestler.process_input': ( 'environments.html#webotswrestler.process_input',
                                                                                     'pct/environments.py'),
            ...
            'pct.webots': { 'pct.webots.WebotsHelper': ('webots.html#webotshelper', 'pct/webots.py'),
                            ...
                            'pct.webots.WebotsHelper.get_inputs_indexes': ('webots.html#webotshelper.get_inputs_indexes', 'pct/webots.py'),
                            'pct.webots.WebotsHelper.get_inputs_names': ('webots.html#webotshelper.get_inputs_names', 'pct/webots.py'),
