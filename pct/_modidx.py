...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'pct.architectures': { 'pct.architectures.BaseArchitecture': ('architectures.html#basearchitecture', 'pct/architectures.py'),
            ...
            'pct.network': { 'pct.network.Client': ('network.html#client', 'pct/network.py'),
                             ...
                             'pct.network.ConnectionManager': ('network.html#connectionmanager', 'pct/network.py'),
                             'pct.network.ConnectionManager.__init__': ('network.html#connectionmanager.__init__', 'pct/network.py'),
                             'pct.network.ConnectionManager.close': ('network.html#connectionmanager.close', 'pct/network.py'),
                             'pct.network.ConnectionManager.connect': ('network.html#connectionmanager.connect', 'pct/network.py'),
                             'pct.network.ConnectionManager.getInstance': ('network.html#connectionmanager.getinstance', 'pct/network.py'),
                             'pct.network.ConnectionManager.isOpen': ('network.html#connectionmanager.isopen', 'pct/network.py'),
                             'pct.network.ConnectionManager.receive': ('network.html#connectionmanager.receive', 'pct/network.py'),
                             'pct.network.ConnectionManager.send': ('network.html#connectionmanager.send', 'pct/network.py'),
                             'pct.network.ConnectionManager.set_port': ('network.html#connectionmanager.set_port', 'pct/network.py'),
