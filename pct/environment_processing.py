...
# %% auto 0
__all__ = ['get_environment_properties', 'wind_turbine_results', 'EnvironmentProcessingFactory', 'BaseEnvironmentProcessing',
...
from .putils import printtime, NumberStats
from .helpers import SolutionsDataManager, ChallengesDataManager



# %% ../nbs/16_environment_processing.ipynb 5
def get_environment_properties(root=None, env='WindTurbine', property_dir=None, property_file=None):

    filename=env+sep+property_dir+sep+property_file
...
# %% ../nbs/16_environment_processing.ipynb 8
...
class BaseEnvironmentProcessing(ABC):
    ...
    def enhance_environment_properties(self, environment_properties=None):
        pass
...
class ARCEnvironmentProcessing(BaseEnvironmentProcessing):
    ...
    def enhance_environment_properties(self, environment_properties=None):
        ...
        # dir = environment_properties['dir'] if 'dir' in environment_properties else 'C:\\packages\\arc-prize-2024'
        ...
        # file_prefix = environment_properties['file_prefix'] if 'file_prefix' in environment_properties else 'arc-agi_training_'
        ...
        environment_properties['data']=data
        ...
        environment_properties['test_output_array']=test_output_array
    ...
    def results(self, filepath=None, experiment=None):
        ...
        drive, property_dir, file = self.get_file_props(filepath=filepath)
        if environment_properties is None:
            environment_properties = get_environment_properties(root=drive, env='ARC', property_dir=property_dir, property_file=file)
            environment_properties['dataset'] = 'test'
            print(environment_properties)

        self.enhance_environment_properties(environment_properties=environment_properties)
        ...
        hierarchy, score = PCTHierarchy.run_from_file(filepath, env_props=environment_properties, history=history, hpct_verbose= verbose, 
                                                  runs=None,   experiment=experiment, 
                                                  min=min)
