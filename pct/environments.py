...
__all__ = ['EnvironmentFactory', 'OpenAIGym', 'CartPoleV1', 'CartPoleDV1', 'PendulumV1', 'PendulumV1_1',
           'MountainCarV0', 'MountainCarContinuousV0', 'VelocityModel', 'DummyModel']
...
class PendulumV1(OpenAIGym):
    ...
    def __init__(self, render=False, video_wrap=False, value=0, name="Pendulum-v1",
                 seed=None, links=None, new_name=True, namespace=None,**cargs):
...
class PendulumV1_1(OpenAIGym):
    ...
    def __init__(self, render=False, video_wrap=False, value=0, name="Pendulum-v1-1",
                 seed=None, links=None, new_name=True, namespace=None,**cargs):
        super().__init__('Pendulum-v1', render=render, video_wrap=video_wrap, value=value, name=name, seed=seed,
                         links=links, new_name=new_name, **cargs)
