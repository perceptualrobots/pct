...
# %% ../nbs/08_architectures.ipynb #a9e7b92b
import os, warnings
import numpy as np
from abc import ABC, abstractmethod

# %% ../nbs/08_architectures.ipynb #177ea85e
...
# %% ../nbs/08_architectures.ipynb #4cdac785
...
# %% ../nbs/08_architectures.ipynb #1b287749
...
# %% ../nbs/08_architectures.ipynb #3b309dfc
...
# %% ../nbs/08_architectures.ipynb #6c4841ce
def run_from_properties_file(root_dir='.', path='.', file=None, nevals=None, runs=500, history=True, verbose=False, 
        ...
        error_collector_type=None, error_response_type=None, draw_file=None, funcdata=False, interactive_mode=False):
    ...
    for seedn in range(seed, nevals+seed, 1):
        ...
        try:
            ...
            if draw:
                if layout==None:
                    hpct.draw(move=move, figsize=figsize, with_edge_labels=True, file=draw_file, funcdata=funcdata, interactive_mode=interactive_mode)
                else:        
                    hpct.draw(move=move, figsize=figsize, with_edge_labels=True, layout=layout, file=draw_file, funcdata=funcdata, interactive_mode=interactive_mode)
...
# %% ../nbs/08_architectures.ipynb #157d5707
...
# %% ../nbs/08_architectures.ipynb #5b2759b2
...
# %% ../nbs/08_architectures.ipynb #53315694
