...
# %% auto #0
__all__ = ['SingletonObjects', 'UniqueNamer', 'FunctionsList', 'Memory', 'NumberStats', 'FunctionsData', 'dynamic_module_import',
...
# %% ../nbs/01_putils.ipynb #356ea38d
def loadjson(file):      
    with open(file) as f:
        rtn = json.load(f)
    return rtn

# %% ../nbs/01_putils.ipynb #4e091c16
...
# %% ../nbs/01_putils.ipynb #5b434800
def list_of_ones(numx):
    x = [1 for i in range(numx) ]
    return x

# %% ../nbs/01_putils.ipynb #631d6ba6
