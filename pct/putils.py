...
__all__ = ['UniqueNamer', 'FunctionsList', 'get_drive', 'stringIntListToListOfInts', 'stringListToListOfString',
           'sigmoid', 'is_in_notebooks']
...
# Cell
def stringListToListOfString(strList, delimiter):
    #listRes = list(strList.split(","))
    #print(listRes)
    result = []
    for item in strList.strip('][').split(','):
