...
# %% ../nbs/11_network.ipynb #solved-invention
import socket
import json

# %% ../nbs/11_network.ipynb #attempted-description
class Server():
...
# %% ../nbs/11_network.ipynb #durable-applicant
class Client():
...
# %% ../nbs/11_network.ipynb #welcome-egypt
